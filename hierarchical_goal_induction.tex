...
\noindent\textbf{Keywords:} goal-to-action mapping, hierarchical detection, plan segmentation, scratchpad tensor, goal-conditioned preference model, iterative distillation, teacher forcing, accessibility tree, weak supervision
...
% ---------------------------------------------------------------------------- %
\section{The Goal-Conditioned Preference Model}
